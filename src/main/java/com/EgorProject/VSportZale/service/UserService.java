package com.EgorProject.VSportZale.service;
    ...
    private void sendMessage(User user) {
        if (!StringUtils.isEmpty(user.getEmail())) {
            String message = String.format(
                    "Привет, %s! \n" +
                            "Добро пожаловать в социальную сеть ВСпортЗале! Для активации учетной записи перейдите по следующей ссылке: http://localhost:8080/activate/%s",
                    user.getUsername(),
